...
/** Блок CTA: регистрация / попробовать. */
    ...
    return (
      <section className="border-t border-line bg-navy text-paper">
        <div className="mx-auto max-w-6xl px-5 py-12">
          <p className="font-mono text-[10px] uppercase tracking-wide text-brand-2">Старт</p>
...
/** Компактный CTA внутри статьи / узкой колонки. */
