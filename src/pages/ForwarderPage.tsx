  ...
  return (
    <main>
      <PageHero
        ...
        dek="1 000 ₽ на счёте — активация. Чтобы ставить — на балансе хватает на 1% от вашей ставки. Комиссия с победы: 1%, без потолка 5 000 ₽."
      />
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {[
            ...
            [
              ...
              'Не «магические 5 000 ₽». Мелкий лот — меньше на счёте; крупный — больше. Параллельные ставки суммируют холд.',
            ],
